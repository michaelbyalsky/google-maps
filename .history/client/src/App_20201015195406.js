...
function App() {
  ...
  const calDistance = React.useCallback((currentLat, currentLng, place) => {
    console.log(place);
  ...
  const onMapClick = React.useCallback((e) => {
    ...
    debugger
    calDistance(e.latLng.lat(), e.latLng.lng(), placeRef.current)
    console.log(e);
    ...
    <div className="app">
      <div className="control">
        <h1>
          ...
          <input ref={placeRef} readOnly value={place && place.MGLSDE_LOC} />
