...
function App() {
  ...
  function getDistanceFromLatLonInKm(lat1, lon1, lat2, lon2) {
    ...
    var dLat = deg2rad(placeRef.X-lat1);  // deg2rad below
    var dLon = deg2rad(placeRef.Y-lon1); 
    var a = 
      Math.sin(dLat/2) * Math.sin(dLat/2) +
      Math.cos(deg2rad(lat1)) * Math.cos(deg2rad(placeRef.X)) * 
  ...
  //     { latitude: placeRef.current.X, longitude: placeRef.current.Y },
